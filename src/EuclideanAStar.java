...
public class EuclideanAStar
{
    ...
    {
        return Math.abs(Math.pow(currentX-goalX,2)+Math.pow(currentY-goalY,2));
    }
    ...
    public static void AStarEuclidean(String InitialState)
    {
        ...
        double currentH = ManhattanAStar.GetHManhattan(Work_Space.toBoardArray(InitialState));
        ...
        while (!Nodeq.isEmpty())
        {
            ...
            if (zeroX != 0)
            {
                ...
                if (!Explored.contains(boardString))
                {
                    ...
                    double currentH1=GetHEuclidean(Work_Space.toBoardArray(nodeToExplore.node1.value));
            ...
            if (zeroY != 0)
            {
                ...
                if (!Explored.contains(boardString))
                {
                    ...
                    double currentH2=GetHEuclidean(Work_Space.toBoardArray(nodeToExplore.node2.value));
            ...
            if (zeroY != 2)
            {
                ...
                if (!Explored.contains(boardString))
                {
                    ...
                    double currentH3=GetHEuclidean(Work_Space.toBoardArray(nodeToExplore.node3.value));
            ...
            if (zeroX != 2)
            {
                ...
                if (!Explored.contains(boardString))
                {
                    ...
                    double currentH4=GetHEuclidean(Work_Space.toBoardArray(nodeToExplore.node4.value));
            ...
            {
                currentH=GetHEuclidean(Work_Space.toBoardArray(nodeToExplore.value));
                assert Nodeq.peek() != null;
                double newH=GetHEuclidean(Work_Space.toBoardArray(Nodeq.peek().getKey().value));
                if (newH<currentH)
                {
                    currentH=newH;
                }
